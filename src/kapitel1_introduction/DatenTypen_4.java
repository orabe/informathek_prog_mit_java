...
public class DatenTypen_4 {
    public static void main(String[] args) {
        ...
        // 9. String Type
        // Hinweis: Strings in Java sind keine primitiven Datentypen (wie int, char usw.).
        // Stattdessen sind alle Strings Objekte einer vordefinierten Klasse namens "String".
        // Und alle String-Variablen sind Instanzen der Klasse "String" (mehr zum Thema Klassen kommt spaeter).
        // Java bietet auch Unterstützung für Zeichenketten durch die Klasse java.lang.String.
        //
        //
        // In Java ist ein String eine Abfolge von Zeichen. Zum Beispiel ist "hello" ein String, der eine Abfolge der
        // Zeichen 'h', 'e', 'l', 'l' und 'o' enthält.
        // Wir verwenden doppelte Anführungszeichen, um einen String in Java zu repräsentieren. Zum Beispiel:
        String meinZeichenkette = "Java-Programmierung"; // einen String erstellen
        // Hier haben wir eine String-Variable namens "meinZeichenkette" erstellt.
        // Die Variable wird mit dem String "Java-Programmierung" initialisiert.

        // Weiter Strings erstellen
        String first = "Java";
        String second = "Python";
        String third = "JavaScript";

        // Strings ausgeben
        System.out.println(first);   // gibt Java aus
        System.out.println(second);  // gibt Python aus
        System.out.println(third);   // gibt JavaScript aus
        // Im obigen Beispiel haben wir drei Strings namens "first", "second" und "third" erstellt.
        // Hier erstellen wir Strings direkt wie primitive Datentypen.
